...
public class CarlMecanumDrive extends MecanumDrive {
    ...
    public CarlMecanumDrive(HardwareMap hardwareMap) {
        ...
        if (CarlDriveConstants.RUN_USING_ENCODER && CarlDriveConstants.MOTOR_VELO_PID != null) {
            setPIDCoefficients(DcMotor.RunMode.RUN_USING_ENCODER, CarlDriveConstants.MOTOR_VELO_PID);
        }
    ...
    public void setPIDCoefficients(DcMotor.RunMode runMode, PIDCoefficients coefficients) {
        for (DcMotorEx motor : motors) {
            motor.setPIDFCoefficients(runMode, new PIDFCoefficients(
                    coefficients.kP, coefficients.kI, coefficients.kD, CarlDriveConstants.getMotorVelocityF()
            ));
        }
    }
    ...
    public List<Double> getWheelPositions() {
        ...
        for (DcMotorEx motor : motors) {
            wheelPositions.add(CarlDriveConstants.encoderTicksToInches(motor.getCurrentPosition()));
        }
    ...
    public List<Double> getWheelVelocities() {
        ...
        for (DcMotorEx motor : motors) {
            wheelVelocities.add(CarlDriveConstants.encoderTicksToInches(motor.getVelocity()));
        }

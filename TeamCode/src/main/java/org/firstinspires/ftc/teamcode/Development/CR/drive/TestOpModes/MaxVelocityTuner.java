 ...
 */
@Config
@Autonomous(group = "drive", name = "CR-MaxVelocityTuner")
public class MaxVelocityTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double effectiveKf = CarlDriveConstants.getMotorVelocityF(veloInchesToTicks(maxVelocity));
    ...
    private double veloInchesToTicks(double inchesPerSec) {
        return inchesPerSec / (2 * Math.PI * CarlDriveConstants.WHEEL_RADIUS) / CarlDriveConstants.GEAR_RATIO * CarlDriveConstants.TICKS_PER_REV;
    }
}

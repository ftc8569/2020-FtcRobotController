...
@Config
@Autonomous
public class PowerShotsAuto extends LinearOpMode {

    SampleMecanumDrive drive;


    public static double shotPower1 = -.6625, shotPower2 = -.6625, shotPower3 = -.6625;

    ShooterController sc;

    public static double shot1y = -31.2, shotdelta1 = 8, shotdelta2 = 16;
